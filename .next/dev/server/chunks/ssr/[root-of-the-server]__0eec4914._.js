...
async function ProductReaderPage({ params }) {
    ...
    // Access check skipped for local testing
    const { data: modulesData, error: modulesError } = await supabase.from('modules').select('id, product_id, title, order_index').eq('product_id', product.id).order('order_index', {
        ascending: true
    });
    if (modulesError) {
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0eec4914._.js.map